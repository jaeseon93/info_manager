		...
		<form id="frm" name="frm" method="post"
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div>
						<input type="text" id="rcttitle" name="rcttitle" class="form-control input" value="${ select.title }">
					</div>
					<label> 영수증 첨부 </label>
					<div>
				...
				<div class="col-md-8">
					<div class="border">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="padding">
									<input class="form-control input" id="total" name="total"
										value="${ select.total }">
							...
							<div class="col-md-8">
								<div class="padding">
									<div class="form-group">
										<textarea class="form-control" rows="5" id="note" name="note">${ select.note }</textarea>
									</div>
								</div>
							</div>
						</div>
