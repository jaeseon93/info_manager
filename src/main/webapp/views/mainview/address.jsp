...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_nav">
			<nav class="sb-sidenav accordion sb-sidenav-dark"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						<a class="nav-link" href="main.jsp"> <svg class="bi bi-house"
  ...
  <path fill-rule="evenodd"
						...
						</a> <a class="nav-link" href="password.jsp"> <svg
								class="bi bi-lock" width="1em" height="1em" viewBox="0 0 16 16"
  ...
  <path fill-rule="evenodd"
						...
						</a> <a class="nav-link" href="note.jsp"><svg class="bi bi-pencil"
								width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
								xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd"
