...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="main.jsp">Information Container</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
  ...
  <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 00.5.5H4v.5a.5.5 0 00.5.5H5v.5a.5.5 0 00.5.5H6v-1.5a.5.5 0 00-.5-.5H5v-.5a.5.5 0 00-.5-.5H3z" clip-rule="evenodd"/>
                            ...
                            <a class="nav-link" href="receipt.jsp" 
  ...
  <path d="M1 5h14v2H1z"/>
                                ...
                                Receipt
                               </a><a class="nav-link" href="address.jsp" 
					...
					<div class="modal fade " id="myModal" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog modal-lg" >
							<div class="modal-content">
								...
								내용 : <input type ="textarea" id="ncontent" name="ncontent">	
