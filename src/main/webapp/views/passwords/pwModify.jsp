...
<script>
	$(function(){ 
		$("#btnUpdate").bind("click",getUpdate);
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Passwords 수정</h4>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" id="btnUpdate" data-dismiss="modal">수정</button>
